...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp22 = new Fuse.Motion.ScrollViewMotion();
        var temp23 = new Fuse.Controls.DockPanel();
        var temp24 = new Fuse.Reactive.DataBinding<int>(newTopTab_Period_inst, "Period");
        var temp25 = new Fuse.Reactive.DataBinding<string>(newTopTab_newTabText_inst, "newTabText");
        var temp26 = new Fuse.Controls.Grid();
        var temp27 = new Fuse.Controls.Rectangle();
        var temp28 = new Fuse.Reactive.DataBinding<string>(temp_Value_inst, "newTabText");
        var temp29 = new Fuse.Controls.Rectangle();
        var temp30 = new Fuse.Drawing.StaticSolidColor(float4(1f, 1f, 1f, 1f));
        var temp31 = new taskCard();
        var temp32 = new settings();
        var temp33 = new Fuse.Drawing.StaticSolidColor(float4(0.09411765f, 0.227451f, 0.4352941f, 1f));
        temp18.LineNumber = 6;
        temp18.FileName = "MainView.ux";
        temp18.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../data/scr/updateTasks.js"));
        temp19.LineNumber = 7;
        ...
        mainViewScroller.Motion = temp22;
        mainViewScroller.Children.Add(temp23);
        temp22.GotoDuration = 0.5f;
        temp22.GotoEasing = Fuse.Animations.Easing.Linear;
        temp23.Children.Add(newTopTab);
        ...
        newTopTab.Bindings.Add(temp25);
        temp26.Columns = "1*, Auto, 1*";
        ...
        temp26.Background = temp30;
        temp26.Children.Add(temp27);
        temp26.Children.Add(temp);
        temp26.Children.Add(temp29);
        temp27.Color = float4(0.8f, 0.8f, 0.8f, 1f);
        temp27.Width = new Uno.UX.Size(80f, Uno.UX.Unit.Percent);
        ...
        temp29.Color = float4(0.8f, 0.8f, 0.8f, 1f);
        temp29.Width = new Uno.UX.Size(80f, Uno.UX.Unit.Percent);
        temp29.Height = new Uno.UX.Size(2f, Uno.UX.Unit.Unspecified);
